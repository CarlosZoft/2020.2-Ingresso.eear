...
&emsp;&emsp;A partir do percurso cognitivo feito, pode-se notar que, no que diz respeito ao aspecto da conformidade do HTA como um todo, muitos dos passos necessários para a realização da tarefa representada não foram demonstrados e descritos no HTA.<br>
&emsp;&emsp;Nota-se, também, a falta de alguns fluxos alternativos que demonstram alguns erros e redundancias no sistema, da representação de operações e suas realaçẽos, além de erros e inconsistências em algumas relações entre subobjetivos.

### O que precisa ser modificado no diagrama e na descrição do hta
&emsp;&emsp;Visto as interpretações apresentadas, no diagrama do HTA devem-se representar as ações e operações que faltam, bem como os fluxos alternativos existentes e as relações corretas entre os subobjetivos.<br>
&emsp;&emsp;Na parte da descrição textual, devem ser corrigidos e adicionados os tópicos referentes a feedbacks, planos, input, problemas e recomendações.
## Relatório dos resultados
&emsp;&emsp;Tendo como objetivo a checagem da coerência da análise de tarefas e sua fidelidade com a utilização do sistema, a presente avaliação tem como escopo todas as ações necessárias para a realização da tarefa denominada como sendo *Efetuar a Inscrição em Concurso*.<br>
&emsp;&emsp;Tal tarefa aborda as ações do usuário ao navegar na plataforma e utilizar o sistema para consegui inscrever-se com sucesso em um concurso.<br>
&emsp;&emsp;A presente avaliação foi executada por um avaliador membro da equipe do projeto, que, utilizando a persona [Cristina Guerra](../../../../analise-de-requisitos/personas/#cristina-guerra), se colocou no lugar do usuário para a realização da técnica de percurso cognitivo, a qual visa a avaliação da facilidade de aprendizado do sistema por parte do usuário guiando a inspeção da interface pelas tarefas do usuário para respondera as seguintes perguntas:
...
&emsp;&emsp;Com base em tudo que foi levantado nessa avalição, os seguintes pontos precisam ser alterados na análise de tarefas:
...
|3.0|23/04/2021|Adição da interpretação e consolidação dos resultados e do realatório dos resultados|Daniel P.|
