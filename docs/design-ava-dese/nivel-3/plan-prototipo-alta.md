...
&emsp;&emsp;Visando uma maior lisura de todo o processo, os participantes convidados para a avaliação terão que concordar com o seguinte termo:
...
- Nossa equipe tem o compromisso de divulgar os resultados de nossas pesquisas para os responsáveis pela plataforma em estudo. A avaliação será gravada e divulgada na GitHub Pages do grupo.<br>
...
## Preparação
#### Tarefas
- [Efetuar a inscrição em concurso;](../../../analise-de-requisitos/analise-de-tarefas/#tarefa-1-efetuar-a-inscricao-em-concurso)
- [Acompanhar inscrição em concurso.](../../../analise-de-requisitos/analise-de-tarefas/#tarefa-2-acompanhar-inscricao-em-concurso)

#### Perfil dos convidados
&emsp;&emsp;Baseado em tudo o que foi levantado durante a análise de requisitos em relação aos usuários, serão convidadas pessoas que possuam um perfil semelhante ao das personas e usuários do Ingresso EEAR.
...
- [Versão interativa do protótipo de alta fidelidade.](https://www.figma.com/proto/xLr41ViZi2XnJqkWKG4WlV/Ingresso.EEAR-Alta-fidelidade?node-id=8%3A2&scaling=min-zoom)
...
&emsp;&emsp;Além disso foi elaborado o seguinte roteiro de perguntas que serão feitas no antes do início da interação e ao término da mesma para auxiliar os avaliadores na coleta e interpretação de dados:
...
&emsp;&emsp;A pergunta número 1 deverá ser feita antes do início da interação e as demais após o término.
